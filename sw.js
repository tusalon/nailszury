...
const urlsToCache = [
  ...
  '/nailszury/vendor/react.production.min.js',
  '/nailszury/vendor/react-dom.production.min.js',
  '/nailszury/vendor/babel.min.js',
  '/nailszury/vendor/bcrypt.min.js',
  '/nailszury/vendor/tailwind-browser.js',
  '/nailszury/vendor/lucide/lucide.css',
  '/nailszury/vendor/lucide/lucide.woff2',
  '/nailszury/utils/push-config.js',
  '/nailszury/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/nailszury/icons/icon-192x192.png',
    badge: '/nailszury/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/nailszury/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/nailszury/admin.html';
  event.waitUntil(
